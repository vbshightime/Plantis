package com.example.webczar.plantis.Utils;
...
/**
 * Created by webczar on 2/23/2018.
 */
...
public class ImageUtils {
   ...
   static {
    ...
    public static void saveBitmap(final Bitmap bitmap, final String filename) {
        ...
        Log.i(LOG_TAG,"Saving %dx%d bitmap to %s.");
    ...
    public static void convertYUV420SPToARGB8888(
        ...
        if (useNativeConversion) {
            try {
                ...
                Log.w(LOG_TAG,"Native YUV420SP -> RGB implementation not found, falling back to Java implementation");
    ...
    public static Matrix getTransformationMatrix(
        ...
        if (applyRotation != 0) {
            if (applyRotation % 90 != 0) {
                Log.w(LOG_TAG,"Rotation of %d % 90 != 0");
                }
